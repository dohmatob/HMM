...
int main(int argc, const char *argv[])
{
  ...
  hmm.baumwelch(lessons, 
		1e-9,
		1000);
  std::cout << "Hi, I'm Maxx the Martian and this is what I've learned from your language." << std::endl;
  std::cout << "There are two kinds of letters --which I'll call vowels and consonants-- distributed as follows:" << std::endl;
